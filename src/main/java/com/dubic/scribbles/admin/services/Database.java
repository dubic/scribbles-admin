...
public class Database {
    ...
    @PostConstruct
    public void inits() {
        Set<EntityType<?>> entities = this.em.getMetamodel().getEntities();
        for (EntityType entity : entities) {
            this.log.info("Mapped ADMIN Entity - " + entity.getName());
        }
    }
    ...
    public <T> List<T> getAll(Class<T> tClass, int start, int size) {
        log.debug(String.format("getAll(%s,%d,%d)", tClass.getSimpleName(),start,size));
